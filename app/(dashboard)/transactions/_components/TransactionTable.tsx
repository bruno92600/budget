...
import { DataTableColumnHeader } from '@/components/database/ColumnHeader'
import { cn } from '@/lib/utils'
import { DataTableFacetedFilter } from '@/components/database/FacetedFilters'
import { DataTableViewOptions } from '@/components/database/ColumnToggle'
    ...
    <div className="w-full">
        ...
        <div className="flex gap-2">
          {table.getColumn("category") && (
            <DataTableFacetedFilter title='Categorie' column={table.getColumn("category")} options={categoriesOptions} />
          )}
