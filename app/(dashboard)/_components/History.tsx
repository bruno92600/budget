                    ...
                    {!dataAvailable && (
                        <Card className='flex h-[300px] flex-col items-center justify-center bg-background'>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Essayez de sélectionner une période différente ou  ajouter une nouvelle transaction
                            </p>
                        </Card>
                    )}
                </SkeletonWrapper>
...
function CustomTooltip({active, payload, formatter}:any) {
    ...
    return (
        <div className="min-w-[300px] rounded border bg-background p-4">
            <TooltipRow formatter={formatter} label="Dépenses" value={expense} bgColor="bg-red-500" textColor="text-red-500" />

            <TooltipRow formatter={formatter} label="Entrer" value={income} bgColor="bg-emerald-500" textColor="text-emerald-500" />

            <TooltipRow formatter={formatter} label="équilibre" value={income - expense} bgColor="bg-gray-100" textColor="text-foreground" />
        </div>
    )
}
